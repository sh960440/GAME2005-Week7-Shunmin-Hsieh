...
void StartScene::draw()
{
	...
	// ImGui Rendering section - DO NOT MOVE OR DELETE // 繪出使用者介面
	if (m_displayUI)
	{
		ImGui::Render();
...
void StartScene::m_updateUI()
{
	...
	ImGui::NewFrame();
	// ImGui::ShowDemoWindow(); // use for debug purposes // 查看示範的介面
	...
	ImGui::SetWindowPos(ImVec2(0, 0), true); // 每一個frame都設定到左上角 // 注意imgui有自己的Vec變量

	/*************************************************************************************************/
	/* MENU                                                                                          */
	/*************************************************************************************************/

	if (ImGui::BeginMenuBar()) // 假如成功出現Menu
	{
